...
class EvaluatorTest(TestCase):
  ...
  def test_error_handling(self) -> None:
    tests: List[Tuple[str, str,]] = [
      ...
      ('5; verdadero - falso;', 'Operador desconocido: BOOLEAN - BOOLEAN'),
      ('''
        si (10 > 7) {
  ...
  def test_builtin_functions(self) -> None:
    tests: List[Tuple[str, Union[str, int]]] = [
      ...
      ('longitud(1);', 'Argumento para longitud sin soporte, se recibio INTEGER'),
      ('longitud("uno", "dos");', 'Numero incorrecto de argumentos para longitud, se recibieron 2, se requieren 1'),
    ]
